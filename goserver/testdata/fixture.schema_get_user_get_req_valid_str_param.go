...
type GetUserGetReqValidStrParam string

var (
	GetUserGetReqValidStrParamHello = GetUserGetReqValidStrParam("he\"llo")
)

// validateSchema validates the object and returns
// errors that can be returned to the user.
func (o GetUserGetReqValidStrParam) validateSchema() support.Errors {
	var ctx []string
	var ers []error
